...
__all__ = [
    ...
    "resnet18_3x3_np", "ResNet18_3x3_Weights_np",
    "resnet34_3x3_np", "ResNet34_3x3_Weights_np",
    "resnet50_3x3_np", "ResNet50_3x3_Weights_np",
    "resnet101_3x3_np", "ResNet101_3x3_np_Weights",
    "resnet152_3x3_np", "ResNet152_3x3_np_Weights",
    "ResNet18_Weights",
    "ResNet34_Weights",
    "ResNet50_Weights",
    "ResNet101_Weights",
...
def _make_resnet_3x3_np(net, weights: Optional[WeightsEnum] = None,
                        progress: bool = True):
    net.conv1 = nn.Conv2d(3, 64, kernel_size=(3, 3),
                          stride=(1, 1), padding=(1, 1), bias=False)
...
def resnet18_3x3_np(*args, weights: Optional[WeightsEnum] = None,
                    progress: bool = True, **kwargs):
    if weights is not None:
        _ovewrite_named_param(kwargs, "num_classes",
                              len(weights.meta["categories"]))

    return _make_resnet_3x3_np(resnet18(*args, **kwargs), weights=weights,
                               progress=progress)


def resnet34_3x3_np(*args, weights: Optional[WeightsEnum] = None,
                    progress: bool = True, **kwargs):
    if weights is not None:
        _ovewrite_named_param(kwargs, "num_classes",
                              len(weights.meta["categories"]))

    return _make_resnet_3x3_np(resnet34(*args, **kwargs), weights=weights,
                               progress=progress)


def resnet50_3x3_np(*args, weights: Optional[WeightsEnum] = None,
                    progress: bool = True, **kwargs):
    if weights is not None:
        _ovewrite_named_param(kwargs, "num_classes",
                              len(weights.meta["categories"]))

    return _make_resnet_3x3_np(resnet50(*args, **kwargs), weights=weights,
                               progress=progress)


def resnet101_3x3_np(*args, weights: Optional[WeightsEnum] = None,
                     progress: bool = True, **kwargs):
    if weights is not None:
        _ovewrite_named_param(kwargs, "num_classes",
                              len(weights.meta["categories"]))

    return _make_resnet_3x3_np(resnet101(*args, **kwargs), weights=weights,
                               progress=progress)


def resnet152_3x3_np(*args, weights: Optional[WeightsEnum] = None,
                     progress: bool = True, **kwargs):
    if weights is not None:
        _ovewrite_named_param(kwargs, "num_classes",
                              len(weights.meta["categories"]))

    return _make_resnet_3x3_np(resnet152(*args, **kwargs), weights=weights,
                               progress=progress)


class ResNet152_3x3_np_Weights(WeightsEnum):
    CIFAR10_s0 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet152_3x3_np-cifar10/model_0.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 58156618,
    ...
    CIFAR10_s1 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet152_3x3_np-cifar10/model_1.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 58156618,
    ...
    CIFAR10_s2 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet152_3x3_np-cifar10/model_2.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 58156618,
    ...
    CIFAR100_s0 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet152_3x3_np-cifar100/model_0.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 58341028,
    ...
    CIFAR100_s1 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet152_3x3_np-cifar100/model_1.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 58341028,
    ...
    CIFAR100_s2 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet152_3x3_np-cifar100/model_2.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 58341028,
...
class ResNet101_3x3_np_Weights(WeightsEnum):
    CIFAR10_s0 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet101_3x3_np-cifar10/model_0.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 42512970,
    ...
    CIFAR10_s1 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet101_3x3_np-cifar10/model_1.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 42512970,
    ...
    CIFAR10_s2 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet101_3x3_np-cifar10/model_2.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 42512970,
    ...
    CIFAR100_s0 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet101_3x3_np-cifar100/model_0.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 42697380,
    ...
    CIFAR100_s1 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet101_3x3_np-cifar100/model_1.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 42697380,
    ...
    CIFAR100_s2 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet101_3x3_np-cifar100/model_2.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 42697380,
...
class ResNet50_3x3_np_Weights(WeightsEnum):
    CIFAR10_s0 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet50_3x3_np-cifar10/model_0.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 23520842,
    ...
    CIFAR10_s1 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet50_3x3_np-cifar10/model_1.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 23520842,
    ...
    CIFAR10_s2 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet50_3x3_np-cifar10/model_2.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 23520842,
    ...
    CIFAR100_s0 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet50_3x3_np-cifar100/model_0.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 23705252,
    ...
    CIFAR100_s1 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet50_3x3_np-cifar100/model_1.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 23705252,
    ...
    CIFAR100_s2 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet50_3x3_np-cifar100/model_2.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 23705252,
...
class ResNet34_3x3_np_Weights(WeightsEnum):
    CIFAR10_s0 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet34_3x3_np-cifar10/model_0.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 21282122,
    ...
    CIFAR10_s1 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet34_3x3_np-cifar10/model_1.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 21282122,
    ...
    CIFAR10_s2 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet34_3x3_np-cifar10/model_2.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR10,
            "num_params": 21282122,
    ...
    CIFAR100_s0 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet34_3x3_np-cifar100/model_0.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 21328292,
    ...
    CIFAR100_s1 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet34_3x3_np-cifar100/model_1.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 21328292,
    ...
    CIFAR100_s2 = Weights(
        url="https://marc.ecs.soton.ac.uk/pytorch-models/model-utilities"
            "/resnet34_3x3_np-cifar100/model_2.pt",
        transforms=ImageClassificationEval,
        meta={
            **_COMMON_META_CIFAR100,
            "num_params": 21328292,
