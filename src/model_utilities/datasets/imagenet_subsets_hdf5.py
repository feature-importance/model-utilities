...
from model_utilities.datasets.imagenet_hdf5 import ImageNetHDF5

IMAGENET_100_SUBSET = ["n02869837", "n01749939", "n02488291", "n02107142", "n13037406", "n02091831", "n04517823",
...
IMAGENET_50_SUBSET = [IMAGENET_100_SUBSET[i] for i in range(0, 100, 2)]

class ImageNet100HDF5(ImageNetHDF5):
    def __init__(self, root, cache_size=None, transform=None, lazy=True):
        super().__init__(root, cache_size=cache_size, transform=transform, lazy=lazy, classes=IMAGENET_100_SUBSET)


class ImageNet50HDF5(ImageNetHDF5):
    def __init__(self, root, cache_size=None, transform=None, lazy=True):
        super().__init__(root, cache_size=cache_size, transform=transform, lazy=lazy, classes=IMAGENET_50_SUBSET)
